 ...
 * FAW system. There are three: the main network on which people trade goods
...
public:
    ...
    bool IsStakeModifierV2(const int nHeight) const { return (nHeight >= nBlockStakeModifierlV2) && (nHeight > nLastPOWBlock); }
