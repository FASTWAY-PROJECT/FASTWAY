...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\FastWay
// Windows >= Vista: C:\Users\Username\AppData\Roaming\FastWay
// Mac: ~/Library/Application Support/FastWay
// Unix: ~/.fastway
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "FastWay";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "fastway.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "fastwayd.pid"));
