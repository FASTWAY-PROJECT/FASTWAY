...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a FastWay address (e.g. %1)").arg("F7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
{
    // return if URI is not valid or is no FAW: URI
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "FastWay.lnk";
}
...
bool isExternal(QString theme)
{
    ...
    if (GetBoolArg("-themeexternal", false)) return true;
