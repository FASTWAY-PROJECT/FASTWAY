...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted FAW to zFAW");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zFAW");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received FAW from zFAW");
    case TransactionRecord::ZerocoinSpend_Change_zPiv:
        return tr("Minted Change as zFAW from zFAW Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zFAW to FAW");
    default:
        return QString();
    }
}
...
QString TransactionTableModel::formatTooltip(const TransactionRecord* rec) const
{
    ...
    if (rec->type == TransactionRecord::RecvFromOther || rec->type == TransactionRecord::SendToOther ||
        ...
        rec->type == TransactionRecord::StakeMint || rec->type == TransactionRecord::MNReward) {
