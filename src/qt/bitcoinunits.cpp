...
QString BitcoinUnits::id(int unit)
{
    ...
    case PIV:
        return QString("fawx");
    case mPIV:
        return QString("mfawx");
    case uPIV:
        return QString::fromUtf8("μfawx");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit, bool isZpiv)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case PIV:
            return z + QString("FAW");
        case mPIV:
            return z + QString("mFAW");
        case uPIV:
            return z + QString::fromUtf8("μFAW");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case PIV:
            return z + QString("tFAW");
        case mPIV:
            return z + QString("mtFAW");
        case uPIV:
            return z + QString::fromUtf8("μtFAW");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case PIV:
            return QString("FAW");
        case mPIV:
            return QString("Milli-FAW (1 / 1" THIN_SP_UTF8 "000)");
        case uPIV:
            return QString("Micro-FAW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case PIV:
            return QString("TestFAWs");
        case mPIV:
            return QString("Milli-TestFAW (1 / 1" THIN_SP_UTF8 "000)");
        case uPIV:
            return QString("Micro-TestFAW (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
