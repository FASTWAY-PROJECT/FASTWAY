    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://fastway.cc/");
    setCssProperty(ui->pushButtonWebLink, "btn-faq-web");
    setCssProperty(ui->containerButtons, "container-faq-buttons");
    connect(ui->pushButtonWebLink, SIGNAL(clicked()), this, SLOT(onPushButtonWebLinkClicked()));
...
void SettingsFaqWidget::onPushButtonWebLinkClicked(){
    QDesktopServices::openUrl(QUrl("https://fastway.cc/"));
}
