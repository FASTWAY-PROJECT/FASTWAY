    ...
    ui(new Ui::RequestDialog)
{
    ...
    ui->labelMessage->setText(tr("Instead of share a FastWay address, you can create a Payment Request message which bundles up more information than is contained in just a FastWay address."));
    ...
    ui->comboBoxCoin->addItem("FAW", 0);
    ui->comboBoxCoin->addItem("zFAW", 1);
...
void RequestDialog::onNextClicked(){
    if(walletModel) {
        ...
        ui->labelTitle->setText("Request for " + BitcoinUnits::format(displayUnit, value, false, BitcoinUnits::separatorAlways) + " FAW");
