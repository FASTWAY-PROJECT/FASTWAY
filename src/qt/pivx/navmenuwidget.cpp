    ...
    logoFrame(0)
{
    ...
    //ui->imgLogo->setPixmap(QPixmap(":/img-nav-logo"));
...
void NavMenuWidget::updateLogoAnimation()
{
    ui->imgLogo->setStyleSheet(QString("background-image:url(:/logo-animation/frame-%1").arg(logoFrame, 3, 10, QChar('0')).append(");"));
    //ui->imgLogo->setPixmap(QString(":/logo-animation/frame-%1").arg(logoFrame, 3, 10, QChar('0')));
    logoFrame = (logoFrame + 1) % 90; // 90 frames
}
