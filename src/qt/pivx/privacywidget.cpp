    ...
    ui(new Ui::PrivacyWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("Minting zFAW anonymizes your FAW by removing any\ntransaction history, making transactions untraceable "));
    setCssSubtitleScreen(ui->labelSubtitle1);

    ui->labelSubtitle2->setText(tr("Mint new zFAW or convert back to FAW"));
    ...
    ui->lineEditAmount->setPlaceholderText("0.00 FAW ");
    ...
    ui->labelValueDenom1->setText("0x1 = 0 zFAW");
    ...
    ui->labelValueDenom5->setText("0x5 = 0 zFAW");
    ...
    ui->labelValueDenom10->setText("0x10 = 0 zFAW");
    ...
    ui->labelValueDenom50->setText("0x50 = 0 zFAW");
    ...
    ui->labelValueDenom100->setText("0x100 = 0 zFAW");
    ...
    ui->labelValueDenom500->setText("0x500 = 0 zFAW");
    ...
    ui->labelValueDenom1000->setText("0x1000 = 0 zFAW");
    ...
    ui->labelValueDenom5000->setText("0x5000 = 0 zFAW");
    ...
    ui->btnTotalzPIV->setTitleClassAndText("btn-title-grey", "Total 0 zFAW");
    ui->btnTotalzPIV->setSubTitleClassAndText("text-subtitle", "Show denominations of zFAW owned.");
    ui->btnTotalzPIV->setRightIconClass("ic-arrow");

    ui->btnCoinControl->setTitleClassAndText("btn-title-grey", "Coin Control");
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select FAW outputs to mint into zFAW.");
...
void PrivacyWidget::onMintSelected(bool isMint){
    QString btnText;
    if(isMint){
        btnText = tr("Mint zFAW");
        ui->btnCoinControl->setVisible(true);
        ui->labelSubtitleAmount->setText(tr("Enter amount of FAW to mint into zFAW"));
    }else{
        btnText = tr("Convert back to FAW");
        ui->btnCoinControl->setVisible(false);
        ui->labelSubtitleAmount->setText(tr("Enter amount of zFAW to convert back into FAW"));
    }
...
void PrivacyWidget::onSendClicked(){
    ...
    if(sporkManager.IsSporkActive(SPORK_16_ZEROCOIN_MAINTENANCE_MODE)) {
        warn(tr("Zerocoin"), tr("zFAW is currently undergoing maintenance"));
        return;
    }
    ...
    if(!GUIUtil::requestUnlock(walletModel, AskPassphraseDialog::Context::Mint_zPIV, true)){
        inform(tr("You need to unlock the wallet to be able to %1 zFAW").arg(isConvert ? tr("convert") : tr("mint")));
        return;
    }
...
void PrivacyWidget::mint(CAmount value){
    ...
    if(!walletModel->mintCoins(value, CoinControlDialog::coinControl, strError)){
        ...
        // Mint succeed
        inform(tr("zFAW minted successfully"));
        // clear
...
void PrivacyWidget::spend(CAmount value){
    ...
    if(!walletModel->convertBackZpiv(
        ...
        // Spend succeed
        inform(tr("zFAW converted back to FAW"));
        // clear
        ui->lineEditAmount->clear();
    }
}
...
void PrivacyWidget::onCoinControlClicked(){
    if(ui->pushRight->isChecked()) {
        if (walletModel->getBalance() > 0) {
            ...
            inform(tr("You don't have any FAW to select."));
        }
    }
}
...
void PrivacyWidget::updateDenomsSupply(){
    ...
    for (const auto& denom : libzerocoin::zerocoinDenomList) {
        ...
        strDenomStats = strUnconfirmed + QString::number(mapDenomBalances.at(denom)) + " x " +
                        ...
                        QString::number(nSumPerCoin) + " zFAW </b>";
