    ...
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelPiv->setText(tr("Stake"));
    ui->labelZpiv->setText(tr("Masternode"));
    ...
    ui->labelAmountZpiv->setText("0 Masternode");
    ui->labelAmountPiv->setText("0 Stake");
    ...
    ui->btnHowTo->setText(tr("How to get FAW"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("FAW")
    updateDisplayUnit();
}
...
void DashboardWidget::changeChartColors(){
    ...
    if(isLightTheme()){
        ...
        gridLineColorX = QColor("#192a56"); //15,11,22
        linePenColorY =  gridLineColorX;
        backgroundColor = linePenColorY;
    ...
    if (set0) set0->setBorderColor(backgroundColor/*gridLineColorX*/);
    if (set1) set1->setBorderColor(backgroundColor/*gridLineColorX*/);
}
...
void DashboardWidget::onChartRefreshed() {
    ...
    if(isLightTheme()){
        set0->setColor(QColor("#192057")); //92,75,125
        set1->setColor(QColor("#4072d5")); //176,136,255
    } else {
        set0->setColor(QColor("#4072d5")); //92,75,125
        set1->setColor(QColor("#51ffff")); //176,136,255
    }
    ...
    ui->labelAmountPiv->setText(GUIUtil::formatBalance(chartData->totalPiv, 0).replace(QRegExp("FAW"), "Stake"));
    ui->labelAmountZpiv->setText(GUIUtil::formatBalance(chartData->totalZpiv, 0).replace(QRegExp("FAW"), "Masternode"));
