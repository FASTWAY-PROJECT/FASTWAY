...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total fastway balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zFAWsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zFAW denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zFAW denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zFAW denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zFAW denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zFAW denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zFAW denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zFAW denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zFAW denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zFAW denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in fastway/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in fastway/kb\n"
    ...
    obj.push_back(Pair("zFAWsupply", zpivObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"fastwayaddress\"\n"
            "\nReturn information about the given fastway address.\n"

            "\nArguments:\n"
            "1. \"fastwayaddress\"     (string, required) The fastway address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"fastwayaddress\", (string) The fastway address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are fastway addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) fastway address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"fastwayaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"fastwayaddress\"  (string, required) The fastway address to use for the signature.\n"
