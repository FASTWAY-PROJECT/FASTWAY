...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "FastWay server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FastWay features */
        {"fastway", "listmasternodes", &listmasternodes, true, true, false},
        {"fastway", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fastway", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fastway", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fastway", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fastway", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fastway", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fastway", "masternodedebug", &masternodedebug, true, true, false},
        {"fastway", "startmasternode", &startmasternode, true, true, false},
        {"fastway", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fastway", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fastway", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fastway", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fastway", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fastway", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fastway", "preparebudget", &preparebudget, true, true, false},
        {"fastway", "submitbudget", &submitbudget, true, true, false},
        {"fastway", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fastway", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fastway", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fastway", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fastway", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fastway", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fastway", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fastway", "checkbudgets", &checkbudgets, true, true, false},
        {"fastway", "mnsync", &mnsync, true, true, false},
        {"fastway", "spork", &spork, true, true, false},
        {"fastway", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"wallet", "splitinputs", &splitinputs, false, false, true},
        ...
        {"zerocoin", "getzfawseed", &getzpivseed, false, false, true},
        {"zerocoin", "setzfawseed", &setzpivseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfaw", &searchdzpiv, false, false, true},
        {"zerocoin", "dzfawstate", &dzpivstate, false, false, true},
...
{
    return "> fastway-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:55225/\n";
}
